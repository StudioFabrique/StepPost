 ...
 */
final class Version20221115185938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE courrier (id INT AUTO_INCREMENT NOT NULL, expediteur_id INT DEFAULT NULL, type INT NOT NULL, bordereau INT NOT NULL, nom VARCHAR(255) NOT NULL, civilite VARCHAR(50) NOT NULL, prenom VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) NOT NULL, complement VARCHAR(255) DEFAULT NULL, codePostal VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, telephone VARCHAR(255) DEFAULT NULL, signature LONGBLOB DEFAULT NULL, UNIQUE INDEX UNIQ_BEF47CAAF7B4C561 (bordereau), INDEX IDX_BEF47CAA10335F61 (expediteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
