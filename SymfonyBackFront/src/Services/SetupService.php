...
class SetupService extends AbstractController
{

    private $configAppService;

    function __construct(ConfigAppService $configAppService){
        $this->configAppService = $configAppService;


    }

    function checkpassService(Request $request):Response{
    ...
    function makeSuperAdminService(Request $request, UserRepository $userRepository, UserPasswordHasherInterface $hasher){
